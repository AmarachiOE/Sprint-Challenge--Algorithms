class SortingRobot:
    ...
    def is_None_in_list(self):
        """
        Looks to see if None is still in list, 
        meaning the robot isn't holding the None card.
        If None still exists, keep sorting.

        If None is no longer in list, return the list. 
        The list is now sorted with all original elements.
        """

        if None in self._list:
            #print("None still in list")
            return self.sort()
